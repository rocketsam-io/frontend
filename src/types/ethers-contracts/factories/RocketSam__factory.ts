...
import type { RocketSam, RocketSamInterface } from "../RocketSam";
...
export class RocketSam__factory {
  static readonly abi = _abi;
  static createInterface(): RocketSamInterface {
    return new Interface(_abi) as RocketSamInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): RocketSam {
    return new Contract(address, _abi, runner) as unknown as RocketSam;
  }
}
